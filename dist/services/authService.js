...
const login = (email, password) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const token = jsonwebtoken_1.default.sign({ id: user.id, email: user.email, role: user.role }, appConfig_1.default.jwtSecret, { expiresIn: '12h' } // Token expira em 1 hora
        );
        return token;
    }
    catch (error) {
...
const register = (firstName, lastName, username, email, contact, password) => __awaiter(void 0, void 0, void 0, function* () {
    try {
