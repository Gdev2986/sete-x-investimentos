                ...
                <Card>
                    <Card.Body>
                        ...
                        <p className="text-muted">
                            Suspendisse vel quam malesuada, aliquet sem sit amet, fringilla elit. Morbi tempor tincidunt
                            tempor. Etiam id turpis viverra, vulputate sapien nec, varius sem. Curabitur ullamcorper
                            fringilla eleifend. In ut eros hendrerit est consequat posuere et at velit.
                        </p>
                        ...
                        <p className="text-muted">
                            ...
                            Maecenas pellentesque porta augue, consectetur facilisis diam porttitor sed. Suspendisse
                            tempor est sodales augue rutrum tincidunt. Quisque a malesuada purus.
                        </p>
                        ...
                        <p className="text-muted">
                            ...
                            eros, sit amet tempor nulla varius sed. Proin nisl nisi, feugiat quis bibendum vitae,
                            dapibus in tellus.
                        </p>
                ...
                <Card>
                    <Card.Body>
                        ...
                        <p className="text-muted">
                            ...
                            In egestas mattis dui. Aliquam mattis dictum aliquet. Nulla sapien mauris, eleifend et sem
                    ...
                    <Card.Body>
                        <Row>
                            ...
                            <Col xl={4} className="mt-3 mt-xl-0">
                                ...
                                <p className="sub-header">A list of items in which the order does explicitly matter.</p>
